...
LOCKOUT_HOURS = 72
APP_URL = "https://fuel-tracker.streamlit.app" # আপনার আসল লিঙ্ক দিন
...
def show_usage_guide():
    ...
    1. **রাইডার:** আইডি সার্চ করে নিজের এলিজিবিলিটি (তেল পাবেন কি না) চেক করতে পারবেন।
    2. **পাম্প:** তেল দিতে হলে অবশ্যই স্টেশন আইডি ও পিন দিয়ে লগইন করতে হবে।
    3. **নিরাপত্তা:** প্রতিবার তেল দেওয়ার সময় গাড়ির ছবি তোলা এবং তেলের ধরন সিলেক্ট করা বাধ্যতামূলক।
